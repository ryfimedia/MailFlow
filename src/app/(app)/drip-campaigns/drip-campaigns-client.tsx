...
export default function DripCampaignsClient({ initialCampaigns, initialListMap }: { initialCampaigns: DripCampaign[], initialListMap: Record<string, string> }) {
  const router = useRouter();
  const { toast } = useToast();
  const [campaigns, setCampaigns] = React.useState<DripCampaign[]>(initialCampaigns);
  const [contactLists, setContactLists] = React.useState<Record<string, string>>(initialListMap);
